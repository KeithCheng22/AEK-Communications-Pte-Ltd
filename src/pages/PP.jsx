    ...
    return(
        <main className='tc'>
            <div class="entry-content">
                ...
                <p className='pp'>i. that AEK Communications correct any such Personal Information; or</p>
                <p className='pp'>ii. that such Personal Information be removed from AEK’s marketing databases.</p>
